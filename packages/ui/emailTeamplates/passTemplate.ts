export function passTemplate(): string {
    return `
      <!DOCTYPE HTML
                                ...
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <div class="v-text-align"
                                      ...
                                      <p style="line-height: 140%; font-size: 14px;"> </p>
                                      <p style="line-height: 140%; font-size: 14px;">We received a request to reset your password for your account at Musix. If you didn't initiate this request, you can safely ignore this email.</p>
