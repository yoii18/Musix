                                  ...
                                  <td class="v-container-padding-padding"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      <tr>
                                        ...
                                        <img align="center" border="0" src="./images/musix.png" alt="image" title="image" width="120px" style="border-radius:14px"/>
                                ...
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <div class="v-text-align"
                                      ...
                                      <p style="line-height: 140%; font-size: 14px;"> </p>
                                      <p style="line-height: 140%; font-size: 14px;">We are thrilled to welcome you to Musix, the ultimate platform for audiophiles like you to enjoy music without any paywall hindrance. Your journey into a world of seamless music exploration starts now!</p>
                                      ...
                                      <p style="line-height: 140%; font-size: 14px;"><strong><span
                                            style="font-family: Raleway, sans-serif; font-size: 14px; line-height: 19.6px;">Team musix.</span></strong>
                                      </p>
                                      <p style="line-height: 140%; font-size: 14px;"> </p>
                                    </div>
                                  ...
                                  <td class="v-container-padding-padding"
                                    ...
                                    <div class="v-text-align"
                                      ...
                                      <p style="font-size: 14px; line-height: 160%;">if you have any questions, please email
                                        us at <a rel="noopener" href="mailto:musixservices@gmail.com"
                                          target="_blank">musixservices@gmail.com</a></p>
                                    </div>
